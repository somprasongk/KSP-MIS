<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="GIS-04.aspx.vb" Inherits="KSP_MIS.GIS_04" %>
    ...
    <div class="kt-portlet" id="PageFilter">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">จำนวนดตีจรรยาบรรณวิชาชีพ
                            </h3>
                        </div>
                    </div>
                    <div class="kt-form kt-form--label-right">
                        <div class="kt-portlet__body">     
                            ...
                            <div class="form-group row">
                                <label class="col-4 col-form-label">ประเภทความผิด</label>
                                <div class="col-8">
                                    <div class="kt-checkbox-list">
                                        ...
                                        <label class="kt-checkbox kt-checkbox--tick kt-checkbox--danger">
                                            <input type="checkbox">
                                            ดูหมิ่น หมิ่นประมาท กล่าวถ้อยคำไม่เหมาะสม                                                                    
											<span></span>
                                        </label>
                                        <label class="kt-checkbox kt-checkbox--tick kt-checkbox--danger">
                                            <input type="checkbox">
                            ...
                            <div class="form-group row">
                                <label class="col-4 col-form-label">สังกัด</label>
                                <div class="col-8">
                            ...
                            <div class="form-group row">
                                <label class="col-4 col-form-label">ขอบเขตพื้นที่</label>
                                <div class="col-8">
                                    <select class="form-control">
                            ...
                            <div class="form-group row">
                                <label class="col-4 col-form-label">การกระจายตัว</label>
                                <div class="col-8">
                                    <select class="form-control">
