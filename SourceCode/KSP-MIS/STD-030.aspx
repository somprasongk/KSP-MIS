<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="STD-030.aspx.vb" Inherits="KSP_MIS.STD_03" %>
...
<asp:Content ID="ScriptContainer" ContentPlaceHolderID="ScriptContainer" runat="server">
    ...
    <script type="text/javascript">
        ...
        var level = ['ระดับพื้นฐาน', 'ระดับกลาง', 'ระดับสูง'];
        ...
        $(document).ready(function () {
            Highcharts.chart('chart1', {
                ...
                tooltip: {
                    ...
                    pointFormat: '{series.name}: {point.y}<br/> รวม {point.stackTotal} หลักสูตร'
                },
                plotOptions: {
                    column: {
                        stacking: 'normal'
