<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ETH-010.aspx.vb" Inherits="KSP_MIS.ETH_01" %>
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable dataTable" role="grid">
                        <thead>
                            <tr role="row">
                                ...
                                <th colspan="13">หน่วยงานต้นสังกัด</th>
                                <th rowspan="2">รวม</th>
                            </tr>
                            <tr>
                                <th>สพฐ.</th>
...
<asp:Content ID="ScriptContainer" ContentPlaceHolderID="ScriptContainer" runat="server">
    ...
    <script type="text/javascript">
        ...
        var Type12 = [
            ...
            , { name: 'ทำร้ายร่างกาย', y: 206 }
            , { name: 'ชู้สาว', y: 206 }
            , { name: 'ความผิดเกี่ยวกับเพศ ', y: 100 }
            , { name: 'การพนันและสุรา,ยาเสพติด', y: 320 }
            , { name: 'ความผิดเกี่ยวกับทรัพย์ ', y: 130 }
            , { name: 'ละทิ้ง,ละเว้น', y: 229 }
            , { name: 'ดูหมิ่น หมิ่นประมาท กล่าวถ้อนคำไม่เหมาะสม', y: 300 }
            , { name: 'ความผิดทางแพ่ง', y: 345 }
        ];
        var Type13 = [
              { name: 'ปฏิบัติหน้าที่โดยมิชอบ', y: 100 }
            , { name: 'ทำร้ายร่างกาย', y: 110 }
            , { name: 'ชู้สาว', y: 100 }
            , { name: 'ความผิดเกี่ยวกับเพศ ', y: 120 }
            , { name: 'การพนันและสุรา,ยาเสพติด', y: 150 }
            , { name: 'ความผิดเกี่ยวกับทรัพย์ ', y: 140 }
            , { name: 'ละทิ้ง,ละเว้น', y: 100 }
            , { name: 'ดูหมิ่น หมิ่นประมาท กล่าวถ้อนคำไม่เหมาะสม', y: 100 }
            , { name: 'ความผิดทางแพ่ง', y: 190 }
        ];
        $(document).ready(function () {
            ...
            Highcharts.chart('chart1', {
                ...
                title: {
                    text: 'จำนวนคดีจรรยาบรรณของวิชาชีพทุกสังกัด จำแนกตามประเภทความผิด พ.ศ. ...',
                    style: {
                        display: 'relative'
                    }
                },
