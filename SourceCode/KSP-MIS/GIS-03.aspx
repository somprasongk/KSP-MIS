<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="GIS-03.aspx.vb" Inherits="KSP_MIS.GIS_03" %>
    ...
    <div class="kt-portlet" id="PageFilter">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">จำนวนผู้ได้รับรางวัลเกียรติคุณ
                            </h3>
                        </div>
                    </div>
                    <div class="kt-form kt-form--label-right">
                        <div class="kt-portlet__body">     
                            ...
                            <div class="form-group row">
                                <label class="col-3 col-form-label">รางวัล</label>
                                <div class="col-9">
