...
<asp:Content ID="ScriptContainer" ContentPlaceHolderID="ScriptContainer" runat="server">
    ...
    <script type="text/javascript">
        ...
        var Type1 = [
              { name: 'ประวัติหน้าที่โดยมิชอบ', y: 5 }
        ...
        var Type2 = [
              { name: 'ประวัติหน้าที่โดยมิชอบ', y: 1200 }
        ...
        var Type3 = [
              { name: 'ประวัติหน้าที่โดยมิชอบ', y: 1000 }
        ...
        var Type4 = [
      { name: 'ประวัติหน้าที่โดยมิชอบ', y: 4000 }
    , { name: 'ทำร้ายร่างกาย', y: 4050 }
    , { name: 'ชู้สาว', y: 4000 }
    , { name: 'ความผิดเกี่ยวกับเพศ ', y: 4000 }
    , { name: 'การพนันและสุรา,ยาเสพติด', y: 3000 }
    ...
    , { name: 'ความผิดทางแพ่ง', y: 3450 }
        ...
        var Type5 = [
      { name: 'ประวัติหน้าที่โดยมิชอบ', y: 3800 }
    ...
    , { name: 'ความผิดทางแพ่ง', y: 2750 }
        ...
        var Type7 = [
              { name: 'ประวัติหน้าที่โดยมิชอบ', y: 3000 }
            , { name: 'ทำร้ายร่างกาย', y: 4050 }
            , { name: 'ชู้สาว', y: 5000 }
        ...
        var Type8 = [
              { name: 'ประวัติหน้าที่โดยมิชอบ', y: 2500 }
        ...
        var Type9 = [
              { name: 'ประวัติหน้าที่โดยมิชอบ', y: 1700 }
        ...
        var Type10 = [
              { name: 'ประวัติหน้าที่โดยมิชอบ', y: 206 }
